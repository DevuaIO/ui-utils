...
import type { ContractKey, ContractState } from "./store";
import {
  contractStore,
 ...
 * all readable through {@link useContract}.
 *
 * @remarks
 ...
 *
 * @remarks
 * Pass the same key as {@link contract} — a `@Tracked` function or a string id.
